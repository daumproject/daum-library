...
class GeneratorDaumActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { GeneratorDaumFactory.createComponentActor() } }
