...
class ReaderDaumActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { ReaderDaumFactory.createComponentActor() } }
