...
@DictionaryType({
        ...
        @DictionaryAttribute(name = "path_disk", defaultValue = "", optional = true)
})
@Provides({
        @ProvidedPort(name = "remote", type = PortType.MESSAGE,theadStrategy = ThreadStrategy.SHARED_THREAD) ,
