...
public class HxmService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage( hxmDriver.HXM_SERVICE_MSG_STATE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
         ...
         */
        Message msg = mHandler.obtainMessage( hxmDriver.HXM_SERVICE_MSG_DEVICE_NAME);
    ...
    private void connectionFailed() {
         ...
         */
        Message msg = mHandler.obtainMessage( hxmDriver.HXM_SERVICE_MSG_TOAST);
        Bundle bundle = new Bundle();
		...
		public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage( hxmDriver.HXM_SERVICE_MSG_READ, bufferIndex, 0, buffer)
                            .sendToTarget();
