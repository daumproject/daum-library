...
public class EntityFactory implements IEntityFactory {
    ...
    public IEntity build(IModel m) {
        ...
        else if(m instanceof Agent) return build((Agent)m);
    ...
    private FireFighterEntity build(Agent d)
    {
        FireFighterEntity  e;
        Drawable icon = DrawableFactory.build(ctx, DrawableFactory.ICON_FIREFIGHTER);
        e = new FireFighterEntity(icon,d.getMatricule());
        if(d.getPosRef() != null)
        {
