...
object SitacFactory {
  ...
  final val classes: Array[Class[_]] = Array(classOf[ActionImpl], classOf[ActionTypeImpl], classOf[AffectationImpl], classOf[AgentImpl], classOf[CategorieImpl], classOf[CibleImpl], classOf[DetachementImpl], classOf[DonneeContextuelImpl], classOf[EntreeImpl], classOf[GpsPointImpl], classOf[HistoriqueImpl], classOf[InfoHorodateImpl], classOf[InfoLignePosImpl], classOf[InfoNiveauImpl], classOf[InfoPosImpl], classOf[InfoResponsableImpl], classOf[InfoTacticImpl], classOf[InfoZoneImpl], classOf[InterventionImpl], classOf[InterventionTypeImpl], classOf[MessageAmbianceImpl], classOf[MoyenImpl],classOf[PersonneImpl], classOf[PositionCivilImpl], classOf[PositionImpl], classOf[PriseEauImpl], classOf[SecteurFontionelImpl], classOf[SecteurGeoImpl], classOf[SinistreImpl], classOf[SitacModelImpl], classOf[SourceDangerImpl], classOf[TypeEntreeImpl],classOf[VehiculeImpl])
}
