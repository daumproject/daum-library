...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(gen.generateStepCompile());


        int ipc_key = 25181;
        int event_port = 9500;
        String binary =   "/home/jed/DAUM_PROJECT/daum-library/pocXenomai/org.kevoree.nativeN/org.kevoree.native.testcomponent/target/org.kevoree.native.testcomponent.uexe";
